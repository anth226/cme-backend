/**
 * THIS FILE IS A COPY, USED FOR MIGRATION ONLY, DO NOT TOUCH
 */
...
type MilitaryResourceUnitCharacteristics = Readonly<{
  health: number;
  range: number;
  damage: number;
  defense: number;
...
type MilitaryResourceUnitProductionCosts = Readonly<{
  iron: number;
  food: number;
  wood: number;
  mkc: number;
...
type MilitaryResourceUnit = Readonly<{
 ...
 */
enum MILITARY_BUILDINGS {
  BARRACK = 'barrack',
}

type MilitaryBuildingTier = Readonly<{
  tier: number;
  availableMilitaryResources: ReadonlyArray<MILITARY_RESOURCES>;
}>;

type MilitaryBuildingUnit = Readonly<{
...
const barrackDescriptor: MilitaryBuildingUnit = {
...
// Stone Hunter
const stoneHunterDescriptor: MilitaryResourceUnit = {
...
// Stone Slinger
const stoneSlingerDescriptor: MilitaryResourceUnit = {
...
// Stone Smasher
const stoneSmasherDescriptor: MilitaryResourceUnit = {
...
// Berserker
const berserkerDescriptor: MilitaryResourceUnit = {
...
// Tribal Warrior
const tribalWarriorDescriptor: MilitaryResourceUnit = {
...
// Tribal Archer
const tribalArcherDescriptor: MilitaryResourceUnit = {
...
// Tribal Brute
const tribalBruteDescriptor: MilitaryResourceUnit = {
...
// Tribal Charger
const tribalChargerDescriptor: MilitaryResourceUnit = {
...
// Swordsman
const swordsmanDescriptor: MilitaryResourceUnit = {
...
// Archer
const archerDescriptor: MilitaryResourceUnit = {
...
// Ax Lord
const axLordDescriptor: MilitaryResourceUnit = {
...
// Executioner
const executionerDescriptor: MilitaryResourceUnit = {
...
// Conscript
const conscriptDescriptor: MilitaryResourceUnit = {
...
// Rifleman
const riflemanDescriptor: MilitaryResourceUnit = {
...
// Heavy Gunner
const heavyGunnerDescriptor: MilitaryResourceUnit = {
...
// Armored Charger
const armoredChargerDescriptor: MilitaryResourceUnit = {
...
// Modern Infantry
const modernInfantryDescriptor: MilitaryResourceUnit = {
  name: MILITARY_RESOURCES.ARMORED_CHARGER,
  characteristics: {
    health: 178,
    damage: 25,
...
// Sharpshooter
const sharpshooterDescriptor: MilitaryResourceUnit = {
...
// Black Ops
const blackOpsDescriptor: MilitaryResourceUnit = {
...
// Demolition Unit
const demolitionUnitDescriptor: MilitaryResourceUnit = {
